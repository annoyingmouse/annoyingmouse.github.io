...
var     max_pics=8;    // set this value to the total number of pictures in film
var     top='0%';      // set this value to position animation top
var     left='0%';     // set this value to position animation left
